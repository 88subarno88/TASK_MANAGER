  ...
  return (
    <div className="animate-slide-up stagger-2">
      <div className="bg-surface border border-border rounded-2xl p-8 shadow-2xl"
        ...
        <p className="text-slate-text text-sm mb-8">Sign in to your encrypted workspace</p>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <button type="submit" disabled={loading}
            className="w-full py-3 px-6 rounded-xl font-display font-semibold text-sm bg-cyan text-void hover:bg-cyan-dim transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed"
        ...
        <p className="text-center text-sm text-slate-text mt-6">
          No account?{' '}
          <Link href="/register" className="text-cyan hover:text-cyan-dim transition-colors font-medium">
            Create one free
          </Link>
        </p>
      </div>
